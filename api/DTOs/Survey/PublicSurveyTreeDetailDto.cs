...
{
    // DTO cây ch? dùng cho PublicSurveyController
    ...
    public class QuestionTreeNodeDto
    {
        ...
        public int? ParentQuestionId { get; set; } // Thêm parentQuestionId ?? h? tr? flow frontend
    }

    public class OptionTreeNodeDto : OptionDto
    {
        public QuestionTreeNodeDto? NextQuestion { get; set; }
        public string? ConditionType { get; set; } // AND/OR cho nhánh n?u có
        public List<int>? BranchOptionIds { get; set; } // Danh sách optionId thu?c nhánh này
    }
}
