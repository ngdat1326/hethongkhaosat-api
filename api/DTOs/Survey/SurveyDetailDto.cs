...
namespace api.DTOs.Survey
{
    public class SurveyDetailDto
    {
        ...
        public List<int> RootQuestionIds { get; set; } = new(); // Thêm danh sách id các câu g?c
    }
    ...
    public class QuestionDetailDto
    {
        ...
        public bool IsRoot { get; set; } // Thêm thu?c tính này
        public int? ParentQuestionId { get; set; } // Thêm parent question id
        public int? ParentOptionId { get; set; }   // Thêm parent option id
    }
