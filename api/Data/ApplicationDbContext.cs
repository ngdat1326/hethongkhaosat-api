...
namespace api.Data
{
    public class ApplicationDbContext : IdentityDbContext<AppUser>
    {
        ...
        public DbSet<UserOtp> UserOtps { get; set; } = null!; // Thêm DbSet cho UserOtp
...
//            );
            ...
            builder.Entity<Answer>()
                ...
                .OnDelete(DeleteBehavior.SetNull); // Cho phép set null khi xóa Question

            builder.Entity<Answer>()
                .HasOne(a => a.Option)
                .WithMany()
                .HasForeignKey(a => a.OptionId)
                .OnDelete(DeleteBehavior.Restrict); // Không cascade, không set null, x? lý b?ng code
        }
    }
}