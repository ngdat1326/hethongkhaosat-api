...
builder.Services.AddScoped<IQuestionBranchRepository, QuestionBranchRepository>();
builder.Services.AddScoped<IQuestionBranchService, QuestionBranchService>();
// Đăng ký lại các repository và service cho Response/Answer
...
builder.Services.AddHostedService<SurveyStatusBackgroundService>();
