...
namespace api.Migrations
{
    ...
    [Migration("20250815063916_AddUserOtpAndIsEmailVerified")]
    partial class AddUserOtpAndIsEmailVerified
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Answer", b =>
                {
                    ...
                    b.Property<string>("ExtraOptionIds")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExtraOptionIdsBackup")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("OptionId")
                        .HasColumnType("int");

                    b.Property<int?>("OptionIdBackup")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("QuestionIdBackup")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.QuestionBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.QuestionBranchOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("QuestionBranchId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QuestionBranchId");

                    b.ToTable("QuestionBranchOptions");
                });
            ...
            modelBuilder.Entity("api.Models.UserOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.QuestionBranch", b =>
                {
                    b.HasOne("api.Models.Question", "CurrentQuestion")
                        .WithMany()
            ...
            modelBuilder.Entity("api.Models.QuestionBranchOption", b =>
                {
                    ...
                    b.HasOne("api.Models.QuestionBranch", "QuestionBranch")
                        .WithMany("BranchOptions")
                        .HasForeignKey("QuestionBranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Option");

                    b.Navigation("QuestionBranch");
                });
